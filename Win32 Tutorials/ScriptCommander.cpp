...
#pragma region Script Completed Class
ScriptCommander::Completion::Completion(const std::string& content) noexcept
	: RedSkyException(0, "@ScriptCommandAbort"), content(content)
{}
...
{
	return "Script Command Complete";
}
#pragma endregion Script Completed Class

#pragma region Script Failure Class
ScriptCommander::Exception::Exception(int line, const char* file, const std::string& script /*= ""*/, const std::string& message /*= ""*/) noexcept
	: RedSkyException(0, "@ScriptCommandAbort"), script(script), message(message)
{}
...
#pragma endregion Script Failure Class