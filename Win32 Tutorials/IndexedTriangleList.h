...
public:
	...
	IndexedTriangleList(rsexp::VertexBuffer verts_in, std::vector<unsigned short> indices_in) : vertices(std::move(verts_in)), indices(std::move(indices_in)) {
	...
	void Transform(DirectX::FXMMATRIX matrix) {
		using Elements = rsexp::VertexLayout::ElementType;
